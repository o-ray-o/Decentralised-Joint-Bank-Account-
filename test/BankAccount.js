...
describe("BankAccount", function () {
  ...
  describe("Withdraw", () => {
    ...
    describe("Make a withdraw", () => {
      it("should allow owner to approve withdraw request", async () => {
      ...
      it("should not allow owner to approve withdraw request twice", async () => {
        const { bankAccount, addr0, addr1 } =
          await deployBankAccountWithAccounts(2, 100, [100]);
      ...
      it("should not allow non-owner to request withdraw request", async () => {
        const { bankAccount, addr1 } = await deployBankAccountWithAccounts(
          2,
          100,
          [100]
